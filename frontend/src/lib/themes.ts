...
// Per-template themes, all derived from the Keepswell brand palette.
// Each template varies which brand color is dominant, but they all share
// the warm-cream background and serif/sans typography for cohesion.
//
// Brand palette: Coral #D86F5C · Warm Cream #F6F1EA · Sand #DCCCB7 ·
//                Sage #7A8A74 · Slate #3C4858 · Charcoal #1F2328
export const journalThemes: Record<string, JournalTheme> = {
  family: {
    name: 'Family Memories',
    bgGradient: 'bg-[#F6F1EA]',
    bgPattern: 'bg-[radial-gradient(#D86F5C18_1px,transparent_1px)] bg-[size:24px_24px]',
    primaryColor: 'text-[#D86F5C]',
    accentColor: 'text-[#7A8A74]',
    textColor: 'text-[#1F2328]',
    mutedColor: 'text-[#3C4858]/70',
    cardBg: 'bg-white/90 backdrop-blur-sm',
    cardBorder: 'border-[#DCCCB7]/70',
    cardShadow: 'shadow-lg shadow-[#D86F5C]/10',
    timelineColor: 'bg-[#DCCCB7]',
    timelineDot: 'bg-[#D86F5C] ring-4 ring-[#F6F1EA]',
  ...
  friends: {
    name: 'Friend Circle',
    bgGradient: 'bg-[#F6F1EA]',
    bgPattern: 'bg-[radial-gradient(#7A8A7418_1px,transparent_1px)] bg-[size:24px_24px]',
    primaryColor: 'text-[#7A8A74]',
    accentColor: 'text-[#D86F5C]',
    textColor: 'text-[#1F2328]',
    mutedColor: 'text-[#3C4858]/70',
    cardBg: 'bg-white/90 backdrop-blur-sm',
    cardBorder: 'border-[#DCCCB7]/70',
    cardShadow: 'shadow-lg shadow-[#7A8A74]/10',
    timelineColor: 'bg-[#DCCCB7]',
    timelineDot: 'bg-[#7A8A74] ring-4 ring-[#F6F1EA]',
    photoFrame: 'ring-4 ring-white shadow-xl',
    photoBorder: 'border-4 border-white',
    icon: 'sparkles',
  ...
  romantic: {
    name: 'Love Story',
    bgGradient: 'bg-[#F6F1EA]',
    bgPattern: 'bg-[radial-gradient(#D86F5C20_1px,transparent_1px)] bg-[size:20px_20px]',
    primaryColor: 'text-[#D86F5C]',
    accentColor: 'text-[#D86F5C]',
    textColor: 'text-[#1F2328]',
    mutedColor: 'text-[#3C4858]/70',
    cardBg: 'bg-white/90 backdrop-blur-sm',
    cardBorder: 'border-[#DCCCB7]/70',
    cardShadow: 'shadow-lg shadow-[#D86F5C]/15',
    timelineColor: 'bg-[#DCCCB7]',
    timelineDot: 'bg-[#D86F5C] ring-4 ring-[#F6F1EA]',
    photoFrame: 'ring-4 ring-white shadow-xl',
    photoBorder: 'border-4 border-white',
  ...
  vacation: {
    name: 'Travel Journal',
    bgGradient: 'bg-[#F6F1EA]',
    bgPattern: 'bg-[radial-gradient(#3C485818_1px,transparent_1px)] bg-[size:24px_24px]',
    primaryColor: 'text-[#3C4858]',
    accentColor: 'text-[#7A8A74]',
    textColor: 'text-[#1F2328]',
    mutedColor: 'text-[#3C4858]/70',
    cardBg: 'bg-white/90 backdrop-blur-sm',
    cardBorder: 'border-[#DCCCB7]/70',
    cardShadow: 'shadow-lg shadow-[#3C4858]/10',
    timelineColor: 'bg-[#DCCCB7]',
    timelineDot: 'bg-[#3C4858] ring-4 ring-[#F6F1EA]',
    photoFrame: 'ring-4 ring-white shadow-xl',
    photoBorder: 'border-4 border-white',
    icon: 'plane',
    quoteStyle: 'font-sans',
  ...
  custom: {
    name: 'Custom Journal',
    bgGradient: 'bg-[#F6F1EA]',
    bgPattern: 'bg-[radial-gradient(#1F232818_1px,transparent_1px)] bg-[size:24px_24px]',
    primaryColor: 'text-[#1F2328]',
    accentColor: 'text-[#D86F5C]',
    textColor: 'text-[#1F2328]',
    mutedColor: 'text-[#3C4858]/70',
    cardBg: 'bg-white/90 backdrop-blur-sm',
    cardBorder: 'border-[#DCCCB7]/70',
    cardShadow: 'shadow-lg shadow-[#1F2328]/10',
    timelineColor: 'bg-[#DCCCB7]',
    timelineDot: 'bg-[#3C4858] ring-4 ring-[#F6F1EA]',
    photoFrame: 'ring-4 ring-white shadow-xl',
    photoBorder: 'border-4 border-white',
...
export const templateInfo: Record<TemplateType, TemplateInfo> = {
  family: {
    ...
    icon: 'heart',
    isPremium: false,
    gradient: 'from-[#D86F5C] to-[#7A8A74]',
  },
  friends: {
    type: 'friends',
    name: 'Friend Circle',
    ...
    icon: 'sparkles',
    isPremium: false,
    gradient: 'from-[#7A8A74] to-[#D86F5C]',
  },
  romantic: {
    type: 'romantic',
    name: 'Love Story',
    ...
    icon: 'heart',
    isPremium: true,
    gradient: 'from-[#D86F5C] to-[#9b4d3f]',
  },
  vacation: {
    type: 'vacation',
    name: 'Travel Journal',
    ...
    icon: 'plane',
    isPremium: true,
    gradient: 'from-[#3C4858] to-[#7A8A74]',
  },
  custom: {
    type: 'custom',
    name: 'Custom Journal',
    ...
    icon: 'book',
    isPremium: false,
    gradient: 'from-[#3C4858] to-[#1F2328]',
  },
};
